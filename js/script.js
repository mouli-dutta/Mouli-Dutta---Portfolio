...
(function () {
  ...
  document.addEventListener('keydown', (e) => {
    ...
    const SKILLS = [
      ...
      { name: 'LLM Security', cat: 'ai', meta: 'Secure LLM deployment' },
      { name: 'OWASP Top 10 for LLM Applications', cat: 'ai', meta: 'LLM security risks' },
      { name: 'Prompt Injection', cat: 'ai', meta: 'LLM attack mitigation' },
      ...
      { name: 'ServiceNow', cat: 'cloud', meta: 'Ticketing & ITSM' },
      { name: 'Jira', cat: 'cloud', meta: 'Project management' },
      { name: 'Confluence', cat: 'cloud', meta: 'Documentation' },
